...
export class StrikersComponent implements OnInit {
  ...
  ngOnInit() {
    this.strickersStats = [];
    var stat1 = new StrickerStat("Sofiane Kecha", 4, 1, 3, 0);
    this.strickersStats.push(stat1);
    var stat3 = new StrickerStat("Hedi Riahi", 2, 1, 3, 0);
    this.strickersStats.push(stat3);
    var stat11 = new StrickerStat("Philippe Tran", 1, 0, 3, 0);
    this.strickersStats.push(stat11);
    var stat2 = new StrickerStat("Cédric Goepfert", 3, 0, 0, 0);
